...
package org.knowhowlab.osgi.jmx;

import org.knowhowlab.osgi.jmx.beans.ServiceAbstractMBean;
import org.knowhowlab.osgi.jmx.beans.framework.*;
...
import org.knowhowlab.osgi.jmx.beans.framework.BundleState;
import org.knowhowlab.osgi.jmx.beans.framework.Framework;
import org.knowhowlab.osgi.jmx.beans.framework.ServiceState;
...
public class Activator implements BundleActivator, OsgiVisitor, LogVisitor {
    ...
    private void registerCompendiumTrackers() {
        permissionAdminTracker = new ServiceTracker(bc, "org.osgi.service.permissionadmin.PermissionAdmin",
                new CompendiumServiceCustomizer<PermissionAdmin>(org.knowhowlab.osgi.jmx.beans.service.permissionadmin.PermissionAdmin.class,
        ...
        configurationAdminTracker = new ServiceTracker(bc, "org.osgi.service.cm.ConfigurationAdmin",
                new CompendiumServiceCustomizer<ConfigurationAdmin>(org.knowhowlab.osgi.jmx.beans.service.cm.ConfigurationAdmin.class,
        ...
        provisioningServiceTracker = new ServiceTracker(bc, "org.osgi.service.provisioning.ProvisioningService",
                new CompendiumServiceCustomizer<ProvisioningService>(org.knowhowlab.osgi.jmx.beans.service.provisioning.ProvisioningService.class,
        ...
        userAdminTracker = new ServiceTracker(bc, "org.osgi.service.useradmin.UserAdmin",
                new CompendiumServiceCustomizer<UserAdmin>(org.knowhowlab.osgi.jmx.beans.service.useradmin.UserAdmin.class,
        ...
        monitorAdminTracker = new ServiceTracker(bc, "org.osgi.service.monitor.MonitorAdmin",
                new CompendiumServiceCustomizer<MonitorAdmin>(org.knowhowlab.osgi.jmx.beans.service.monitor.MonitorAdmin.class,
